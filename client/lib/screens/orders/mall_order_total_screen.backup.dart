...
/// 商城订单总表页面
class MallOrderTotalScreen extends ConsumerStatefulWidget {
  const MallOrderTotalScreen({super.key});

  @override
  ConsumerState<MallOrderTotalScreen> createState() => _MallOrderTotalScreenState();
}

class _MallOrderTotalScreenState extends ConsumerState<MallOrderTotalScreen> {
  // 搜索控制器

...
/// 集货商订单总表页面
class CollectorOrderTotalScreen extends ConsumerStatefulWidget {
  const CollectorOrderTotalScreen({super.key});

  @override
  ConsumerState<CollectorOrderTotalScreen> createState() => _CollectorOrderTotalScreenState();
}

class _CollectorOrderTotalScreenState extends ConsumerState<CollectorOrderTotalScreen> {
  // 搜索控制器
  ...
  void initState() {
    ...
    _orders = List.generate(50, (index) => {
      ...
      'orderNumber': 'COLLECT-20251228-${index.toString().padLeft(4, '0')}',
                      ...
                      actions: [
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text('已删除选中的订单')),
                            );
                          },
                          child: const Text('删除'),

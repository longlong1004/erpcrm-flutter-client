...
import 'package:erpcrm_client/screens/warehouse/delivery_add_screen.dart';
import 'package:erpcrm_client/screens/warehouse/delivery_detail_screen.dart';

class DeliveryApplicationScreen extends ConsumerWidget {
                          ...
                          TextButton(
                            onPressed: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => DeliveryDetailScreen(deliveryData: deliveryData),
                                ),
                              );
                            },
                            child: const Text('查看'),
                          ...
                          TextButton(
                            onPressed: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => DeliveryAddScreen(deliveryData: deliveryData),
                                ),
                              );
                            },
                            child: const Text('编辑'),
                            ...
                            onPressed: () {
                              ...
                              showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: const Text('确定要撤回该出库申请吗？撤回后状态变更为"已撤销"，数据不再进入审核流程。'),
                                  actions: [
                                    TextButton(

...
class InventoryEditScreen extends StatefulWidget {
  ...
  const InventoryEditScreen({super.key, this.inventoryData});
...
class _InventoryEditScreenState extends State<InventoryEditScreen> {
  ...
  void initState() {
    ...
    if (widget.inventoryData != null) {
      _controllers.forEach((key, controller) {
        controller.text = widget.inventoryData![key]?.toString() ?? '';
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      title: widget.inventoryData == null ? '新增库存商品' : '编辑库存商品',
      child: Padding(
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    widget.inventoryData == null ? '新增库存商品' : '编辑库存商品',
                  ...
                  const SizedBox(height: 16),
                  _buildFormField('库存数量', '库存数量', keyboardType: TextInputType.number),
                  const SizedBox(height: 16),
